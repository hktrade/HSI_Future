...
TRADING_PERIOD = KLType.K_5M  # 信号 K 线周期 KLType.K_3M
TRADING_SECURITY = 'HK.TCH220530C250000'  # 交易标的 
FAST_MOVING_AVERAGE = 9 # 均线快线的周期
SLOW_MOVING_AVERAGE = 48  # 均线慢线的周期
...
def on_bar_open():
    ...
    # 获取 K 线，计算均线，判断多空
    bull_or_bear = calculate_bull_bear('HK.00700', FAST_MOVING_AVERAGE, SLOW_MOVING_AVERAGE)
